...
// Module Name: data_read_tb
// Target Device: N/A
// Tool versions: QuestaSim 10.6c
// Description: 
// Testbench of the Sync FIFO read data, from Arbiter -> FIFO -> Arbiter, to verify
// the basic function of arbiter read ctrl. This testbench verify the basic function
// of FIFO:
//     [1]: Basic FIFO read (POP and nPOP)
//     [2]: FIFO status varies with FIFO stack volume
//     [3]: FIFO and Arbiter behavior during a request after FIFO empty
// Dependencies:
// top_wrapper.v
//
// Revision:
...
always @(posedge clk or negedge rst_n) begin
    if (rst_n == 1'b0) begin
        ...
        if (read_counter < DEPTH) begin // read fifo reg
            read_counter <= read_counter + 1'b1;
            arbiter_0(`DATA_ERR_IDX     , 8'd255);
            arbiter_0(`WRITE_PTR        , 8'd255);
            arbiter_0(`WRITE_PTR_ERR_IDX, 8'd255);
            arbiter_0(`READ_PTR         , 8'd255);
            arbiter_0(`READ_PTR_ERR_IDX , 8'd255);
            arbiter_0(`FIFO_OUT_DATA    , 8'd255);
        end
        else begin // request when fifo empty
            arbiter_0(`DATA_ERR_IDX     , 8'd255);
            arbiter_0(`WRITE_PTR        , 8'd255);
            arbiter_0(`WRITE_PTR_ERR_IDX, 8'd255);
            arbiter_0(`READ_PTR         , 8'd255);
